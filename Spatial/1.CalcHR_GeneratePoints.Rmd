...
## Export spatial objects for ease of import later    
```{r}
# str(Mystacinus_points)
# output_today

# "C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/1. Nittedal 2018-2020/Nittedal_Main/Analyses/Outputs/HomeRangeExploration_2026-06-15"

### Also moved a copy to the Inputs/Spatial folder 

# saveRDS(Mystacinus_points, file =file.path(output_today, "Mystacinus_points_sf.rds"))
# saveRDS(Mystacinus_ranges, file =file.path(output_today, "Mystacinus_ranges_sf.rds"))
# 
# saveRDS(Brandts_points, file =file.path(output_today, "Brandts_points_sf.rds"))
# saveRDS(Brandts_ranges, file =file.path(output_today, "Brandts_ranges_sf.rds"))
```
