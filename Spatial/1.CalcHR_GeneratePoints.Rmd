...
BrandtsHR <-
  ...
  tm_borders(fill_alpha=.7, col = "#32a5ff", lwd = 2) + 
  tm_fill(fill_alpha=.1, fill_alpha = "#32a5ff") +
...
CombinedHR <-
  ...
  tm_basemap("CartoDB.Voyager") +
  tm_scalebar(position = c("top", "right"), width = 200, text.size = 1.5) +   tm_scalebar(position = c("top", "right"), width = 200, text.size = 15)
