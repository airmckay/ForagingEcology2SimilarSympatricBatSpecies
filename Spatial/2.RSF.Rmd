...
output_today
# "C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/1. Nittedal 2018-2020/Nittedal_Main/Analyses/Outputs/RSF_50mRadius_2025-11-19"
...
test <- dt1df %>% select(BatID, Species) %>% distinct() %>% arrange(Species)
 print(test)
...
table(openareas$BatID)
  ...
  #     29      101       87      173       84      111        8       78       36       77 
  #  Maren    Marie     Nora   Phoebe Ragnhild    Reeda    Sofia   Steffi    Stine     Thea 
  #    243       32       54       84       26       10       27       67      147      203 
  #  Turid 
  #      0 
